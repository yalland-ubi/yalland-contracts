...
module.exports = async function(deployer, network, accounts) {
  ...
  deployer.then(async () => {
    ...
    const coinTariffResponse = await city.createTariff("Pay coins", Web3.utils.toWei('10', 'ether'), (60 * 60 * 5).toString(), "0", coinToken.address, { from: coreTeam });
    const coinTariffId = coinTariffResponse.logs[0].args.id;
    console.log('coinTariffId', coinTariffId);
